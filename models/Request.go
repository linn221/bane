...
type Request struct {
	...
	HttpQueries         mystructs.KVPairGroup `gorm:"not null"`
	HttpHeaders         mystructs.KVPairGroup `gorm:"not null"`
	HttpCookies         mystructs.KVPairGroup `gorm:"not null"`
	...
	ResponseHeaders     mystructs.KVPairGroup `gorm:"not null"`
	ResponseCookies     mystructs.KVPairGroup `gorm:"not null"`
}
